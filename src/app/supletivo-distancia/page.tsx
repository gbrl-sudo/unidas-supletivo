...
export default function SupletivoDistanciaPage() {
  const course = COURSES.ead;
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="order-2 md:order-1 p-8 md:p-16 flex items-center justify-center">
            <div className="max-w-md">
              ...
              <p className="text-xl text-white/90 mb-6">
                Estude onde e quando quiser com a nossa plataforma online.
              </p>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-2">Conheça o Curso Online</h2>
          <p className="text-xl text-center text-gray-600 mb-10">Flexibilidade e conteúdo de qualidade para você conquistar seu diploma.</p>
        ...
        {/* CTA Section */}
        <div className="mt-16">
          <div className="bg-primary text-white rounded-lg shadow-xl">
            <div className="p-12 text-center">
              <h2 className="text-3xl font-bold mb-4">
                Estude de onde estiver, no seu tempo!
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Aproveite a flexibilidade do ensino a distância para conquistar seu diploma. Nossa plataforma está pronta para você.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg"
                  className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 text-lg font-semibold shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
                  onClick={handleWhatsAppClick}
                >
                  <Image src="/whatsapp.svg" alt="WhatsApp" width={20} height={20} className="mr-2" />
                  WhatsApp: {CONTACT_INFO.phone}
                </Button>
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-primary px-8 py-4 text-lg font-semibold transform hover:-translate-y-0.5 transition-all duration-300"
                  asChild
                >
                  <Link href="/#contato">
                    Ver Mais Contatos
